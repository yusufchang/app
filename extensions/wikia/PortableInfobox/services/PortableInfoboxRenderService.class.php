...
class PortableInfoboxRenderService extends WikiaService {
	...
	private static $templates = [
		...
		'gallery-mobile' => 'PortableInfoboxGalleryMobile.mustache'
	];
	...
	public function renderInfobox( array $infoboxdata, $theme, $layout ) {
		...
		$infoboxHtmlContent = $this->renderGalleryMobile( $this->mockGalleryData() ) . $infoboxHtmlContent;
	...
	private function renderGalleryMobile( $data ) {
		$helper = new PortableInfoboxRenderServiceHelper();
		$galleryData['images'] = array_map([$helper,'extendImageData'], $data);

		$markup = $this->renderItem( 'gallery-mobile', $galleryData );
		return $markup;
	}
