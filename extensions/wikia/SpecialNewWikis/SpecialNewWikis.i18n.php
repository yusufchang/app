<?php
/**
 * Internationalization file for SpecialNewWikis extension.
 *
 * @file
 * @ingroup Extensions
 */
...
$messages['fi'] = array(
	'newwikis' => 'Näytetään Wikit alkaen:',
	'newwikisstart' => 'Näytetään Wikit alkaen:',
);
...
$messages['ja'] = array(
	'newwikis' => '次の文字列から始まるウィキを表示:',
	'newwikisstart' => '次の文字列から始まるウィキを表示:',
);

$messages['ko'] = array(
	'newwikis' => '다음 제목으로 시작하는 위키:',
	'newwikisstart' => '다음 제목으로 시작하는 위키:',
);
