<?php
/**
 * Class definition for Wikia\Search\QueryService\Select\Dismax\OnEntertainment
 */
 ...
 */
class OnEntertainment extends AbstractDismax
{
	/**
	 * Used for tracking
	 * @var string
	 */
	protected $searchType = 'entertainment';
