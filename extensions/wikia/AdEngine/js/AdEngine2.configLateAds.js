...
/*global AdConfig2Late, Wikia, window, postscribe, document, Geo, Krux, jQuery*/
/*jslint newcap: true*/
(function (log, tracker, window, postscribe, document, Geo, Krux, $) {
	'use strict';
...
}(Wikia.log, Wikia.Tracker, window, postscribe, document, Geo, Krux, jQuery));
