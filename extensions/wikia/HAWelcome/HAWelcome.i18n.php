...
* Link auf Seite #2
* Link auf Seite #3",
	'welcome-message-user' => '==Willkommen==
...
$messages['el'] = array(
	'welcome-message-user' => 'Γειά σας, καλώς ήρθατε στο {{SITENAME}}! Ευχαριστούμε για τη συνεισφορά σας στη σελίδα [[:$1]].

Παρακαλώ στείλτε μου μύνημα στη [[$2|σελίδα σηζητήσεών μου]] αν μπορώ να βοηθήσω σε κάτι! $3',
...
* Página favorita #2
* Página favorita #3",
	'welcome-message-user' => '==Bienvenido==
...
Bonnes modifications !",
	...
	'welcome-user' => 'Cette page est ta page personnelle. Tu peux y ajouter des informations te concernant !
...
Se hai bisogno di aiuto, innanzitutto consulta le nostre [[w:c:it.community:Aiuto:Contenuti|pagine di aiuto]]. Visita inoltre la [[w:c:it.community|Wiki della Community]] per tenerti informato tramite il [[w:it:Blog:Blog ufficiale di Wikia Italia|blog ufficiale di Wikia Italia]], fare domande nel [[w:it:Special:Forum|forum]] o chattare con gli altri utenti.<br>
Buon editing!",
	'welcome-user' => "==Qualcosa su di me==
...
* Pagina preferita n.2
* Pagina preferita n.3",
	'welcome-message-wall-anon' => "Ciao, benvenuto su {{SITENAME}}! Grazie per la tua modifica nella pagina $1.

'''[[Special:Userlogin|Per favore registrati e crea il tuo nome utente]]'''. È un modo semplice per tener traccia dei tuoi contributi e ti aiuta a comunicare con il resto della community.

Lasciami un messaggio se hai bisogno di aiuto!",
	'welcome-message-wall-anon-staff' => "Ciao, benvenuto su '''{{SITENAME}}'''! Grazie per la tua modifica nella pagina '''\"\$1\"'''.

Ti invitiamo a '''[[Special:UserSignup|creare il tuo username]]'''. È un modo semplice per tener traccia dei tuoi contributi, avere accesso ad altre fuzioni di Wikia e comunicare con il resto della community di {{SITENAME}}.

Se ricevi questo messaggio, è probabile allora che {{SITENAME}} sia inattiva o non abbia amministratori attivi. Questo significa che qui hanno bisogno di te! Controlla le [[Special:Recentchanges|ultime modifiche]] o la [[Special:Listusers|lista utenti]] per vedere chi è ancora attivo e prova ad offrire il tuo aiuto, oppure contribuisci direttamente alla wiki. Una volta registrato, se raggiungerai i requisiti potrai fare richiesta d'adozione della wiki su [[w:it:Wiki della Community:Richieste di adozione|questa pagina]].
...
それではどうぞ編集をお楽しみください！",
	'welcome-user' => '@latest',
	'welcome-bot' => '@bot',
	'welcome-message-wall-user' => 'こんにちは、{{SITENAME}}へようこそ！ [[:$1]]ページの編集ありがとうございます。

もし私に何かお役に立てることがあるときは、私のところに伝言を残してください！',
	'welcome-message-wall-user-staff' => 'こんにちは、{{SITENAME}} へようこそ！ [[:$1]]のページ編集ありがとうございます。もしあなたがヘルプを必要としているのであれば、[[ヘルプ:コンテンツ|ヘルプページ]]を一読するか、[[特別:Listusers/sysop|ローカルの管理者]]に連絡してみてください。もしこのウィキアに活動中の管理者がいないのであれば、[[w:ja:|コミュニティセントラル]]にお立ち寄り、[[w:ja:特別:Forum:|フォーラム]]も覗いてみてください。



すぐにでもヘルプをお探しですか？ 次回の[[w:Webinars|ウェビナー]] (英語) でスタッフやウィキアの編集者が参加しているチャットに参加してみてください。最新のニュースやウィキアで起きている出来事の最新情報を入手するために[[w:ja:ブログ:ウィキアスタッフブログ|スタッフブログ]] ([[w:Blog:Wikia_Staff_Blog|英語]]) をチェックすることもできます。最後に、プレミアムライセンスの動画を閲覧できる[[w:c:video|ウィキアビデオライブラリ]]も見てください。

これらのリンクはすべて、ウィキアを探索するよい方法です。

それでは楽しい編集を！',
	'welcome-message-wall-anon' => "こんにちは、{{SITENAME}}へようこそ！　[[:$1]]ページの編集ありがとうございます。

'''[[Special:Userlogin|サインインしてユーザー名の作成をお願いします]]'''。これは自分の投稿の経過を追う簡単な方法でなおかつ、その他のコミュニティとコミュニケーションを取るのに役に立ちます。

もし私に手伝えることがあるときは、私のところに伝言を残してください！",
	'welcome-message-wall-anon-staff' => "こんにちは、{{SITENAME}} へようこそ！ [[:$1]] ページをご編集いただきありがとうございます。
...
もし何か手伝いできることがありましたら、お気軽にメッセージを残してくださいね！",
...
*2번째 관심 문서
*3번째 관심 문서',
	'welcome-message-user-staff' => '==환영합니다!==

안녕하세요. {{SITENAME}}에 오신 것을 환영합니다.
[[:$1]] 문서를 편집해주셔서 감사드립니다.

만약 도움이 필요한데 이 위키의 관리자가 활동중이 아니라면 [[w:c:ko:포럼:중앙 커뮤니티 포럼|중앙 커뮤니티의 포럼]]을 방문해보세요.',
	'welcome-message-anon-staff' => "==환영합니다!==
...
만약 도움이 필요한데 이 위키의 관리자가 활동중이 아니라면 [[w:c:ko:포럼:중앙 커뮤니티 포럼|중앙 커뮤니티의 포럼]]을 방문해보세요. $3",
	'welcome-message-wall-user-staff' => '안녕하세요. {{SITENAME}}에 오신 것을 환영합니다. $1 문서를 편집해주셔서 감사드립니다.

만약 도움이 필요한데 이 위키의 관리자가 활동중이 아니라면 [[w:c:ko:포럼:중앙 커뮤니티 포럼|중앙 커뮤니티의 포럼]]을 방문해보세요. [[w:c:community:Blog:Wikia_Staff_Blog|스태프 블로그 (영어)]]를 주시하시면 위키아의 최근 소식을 알아볼 수 있습니다.',
	'welcome-message-wall-anon-staff' => "안녕하세요. {{SITENAME}}에 오신 것을 환영합니다. [[:$1]] 문서를 편집해주셔서 감사드립니다.

'''[[Special:Userlogin|먼저 계정을 만드셔서 활동하시는 것을 권해드립니다.]]''' 이는 회원님의 기여를 쉽게 추적하고 다른 사용자분들과 쉽게 소통할 수 있는 좋은 방법입니다.
...
''Esta é sua pagina de usuário. Por favor, edite esta pagina para contar mais sobre voce para a comunidade!''
...
Если вам нужна помощь, а администраторы данной вики отсутствуют:
* Посетите [[Справка:Содержание|страницы Справки]], где есть ответы на большинство простых вопросов.
* Изучите справочные видео-курсы в [[w:c:ru.community:Университет_Викия|Университете Викия]]
* Прочтите [[w:c:ru.community|последние записи в блогах]], чтобы узнать о новых возможностях и обновлениях Викия.
...
* trang thứ 2
* trang thứ 3",
	'welcome-message-user' => '==Hoan nghênh==
...
Biên tập vui vẻ! $3",
	...
	'welcome-message-wall-user' => 'Chào bạn, hoan nghênh bạn đến {{SITENAME}}! Cảm ơn bạn đã sửa đổi trang [[:$1]].
...
$messages['zh'] = array(
	'welcome-message-user' => '您好，欢迎来到{{SITENAME}}！ 感谢您对[[:$1]]页面的编辑。

请在[[$2|我的讨论页]]给我留言，希望我能够帮到您！$3',
...
欢迎来到{{SITENAME}}，感谢您对页面[[:$1]]的编辑。如果您需要帮助，请从访问[[Help:Contents|帮助页面]]开始。访问[[w:c:community|社群中心]]以评论我们的[[w:c:zh.community:博客:博客帖子|职员博客]]，在[[w:c:zh.community:Special:Forum|社区中心论坛]]提问问题，或与其他维基人聊天。祝编辑愉快！',
	'welcome-message-wall-anon' => '嗨！欢迎来到{{SITENAME}}，感谢您对页面[[:$1]]的编辑。我们鼓励所有贡献者[[Special:UserLogin|创建用户名]]，这样您就可以跟踪您的贡献，访问更多Wikia功能并与{{SITENAME}}其他社群成员保持亲近。
