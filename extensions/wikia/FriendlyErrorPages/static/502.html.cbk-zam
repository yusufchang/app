		...
		<body>
			<div id="wrapper">
				<div id="content">
					...
					<div class="friendly">
						<h1>We are sorry!</h1>
						<p>It appears there is a problem with your IP connection and Wikia. Try clearing your browser cache and reloading the page. 
If you also see this problem on other websites then either your ISP has a major equipment failure/overload or there is something wrong with your internal Internet connection. We recommend reviewing our internet setup and contacting your ISP.</p>
					</div>
					<div class="links">
