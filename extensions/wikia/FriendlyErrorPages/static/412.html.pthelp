			...
			<div id="wrapper">
				<div id="content">
					...
					<div class="friendly">
						...
						<p>Your request does not meet all conditions of our servers. Please try again. If the problem continues, please feel free to <a  class="text" href="http://community.wikia.com/wiki/Special:Contact">contact us</a>.</p>
					</div>
					<div class="links">
