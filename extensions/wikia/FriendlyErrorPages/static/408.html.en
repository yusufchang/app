		...
		<body>
			<div id="wrapper">
				<div id="content">
					...
					<div class="friendly">
						<h1>Oops, there appears to be a problem!</h1>
						<p>Unfortunately our servers took too long for your request to complete. Sorry and please try again. If the problem continues, please feel free to <a  class="text" href="http://community.wikia.com/wiki/Special:Contact">contact us</a>.</p>
					</div>
					<div class="links">
