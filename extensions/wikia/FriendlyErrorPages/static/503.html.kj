		...
		<body>
			<div id="wrapper">
				<div id="content">
					...
					<div class="friendly">
						<h1>We are sorry!</h1>
						<p>This is so embarrassing but there seems to be a small problem with our servers or we are carrying out repairs. We expect to be back up and running shortly. If the problem continues, please feel free to <a  class="text" href="http://community.wikia.com/wiki/Special:Contact">contact us</a>.</p>
					</div>
					<div class="links">
