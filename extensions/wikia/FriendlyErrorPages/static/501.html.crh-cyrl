		...
		<body>
			<div id="wrapper">
				<div id="content">
					...
					<div class="friendly">
						<h1>We are sorry!</h1>
						<p>Sorry, there seems to be a problem with your Internet connection.The problem is usually caused by a third party product interfering with your browser.</p>
					</div>
					<div class="links">
