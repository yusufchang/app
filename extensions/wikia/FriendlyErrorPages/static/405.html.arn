			...
			<div id="wrapper">
				<div id="content">
					...
					<div class="friendly">
						...
						<p>The request you made is not one that we support. Please check the URL and try again. If the problem continues, please feel free to <a  class="text" href="http://community.wikia.com/wiki/Special:Contact">contact us</a>.</p>
					</div>
					<div class="links">
