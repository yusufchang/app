		...
		<body>
			<div id="wrapper">
				<div id="content">
					...
					<div class="friendly">
						<h1>We are sorry!</h1>
						<p>Interesting. You seem to be using a version of HTTP we don't support. Please use HTTP 1.1. If this problem persists please <a  class="text" href="http://community.wikia.com/wiki/Special:Contact">contact us</a>.</p>
					</div>
					<div class="links">
					...
					<div class="technical">
						...
						<p>&lt;friendlyerrorpages-errorpage-technical-explanation-505&gt;</p>
					</div>
			</div> <!-- #content -->
		</div> <!-- #wrapper -->
	</body>
