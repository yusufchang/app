...
In the first case, only your ISP can help you. In the second case, you need to fix whatever it is that is preventing you reaching the Internet.<br/>",
        ...
        'friendlyerrorpages-errorpage-explanation-503' => "We are temporarily down (probably for repairs). Please try again in a moment!",
        ...
        'friendlyerrorpages-errorpage-explanation-504' => "There is something wrong with our server. Please visit us later!",
        ...
        'friendlyerrorpages-errorpage-explanation-505' => "Interesting. You seem to be using a version of HTTP we don't support. Please use HTTP 1.1. If this problem persists [http://community.wikia.com/wiki/Special:Contact contact us].",
