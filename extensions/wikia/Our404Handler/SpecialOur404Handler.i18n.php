<?php
/**
 * Internationalization file for Our404Handler extension.
 *
 * @file
 * @ingroup Extensions
 */
 ...
 */
$messages['ml'] = array(
	'our404handler' => 'പിഴവ് 404: താൾ കണ്ടെത്താനായില്ല!',
	'our404handler-oops' => 'ഇവ താങ്കൾ അന്വേഷിക്കുന്ന താളുകളല്ല. ദയവായി മറ്റുതാളുകൾ കാണുക.',
	'message404' => "'''താങ്കൾ ആവശ്യപ്പെട്ട താൾ നിലവിലുള്ളതല്ല, ഞങ്ങൾ ആത്മാർത്ഥമായി ഖേദിക്കുന്നു'''

'''$1''' എന്ന ലേഖനം കണ്ടെത്താനായില്ല
...
$messages['pl'] = array(
	...
	'message404' => "
'''Niestety, ale z jakiegoś powodu wybrana strona nie istnieje.'''
...
* Погледајте чланак [[$2]]
* Пробајте претрагу с леве стране странице
...
$messages['tt-cyrl'] = array(
	...
	'message404' => "'''Мондый бит юк.'''

'''$1'''  мәкаләсен табып булмый.
...
$messages['uk'] = array(
	...
	'our404handler-oops' => 'Сторінки, яку ви шукаєте, не існує. Будь ласка, йдіть далі.',
	'message404' => "'''Ми дуже шкодуємо, але чомусь сторінки яку ви запросили, не існує.'''

Стаття '''$1''' не може бути знайдена.

* Ви можете спробувати статтю [[$2]].
* Ви можете скористатися вікном пошуку в лівій частині сторінки.
* Щоб перейти на головну сторінку сайту, натисніть на це посилання [{{SERVER}} {{SITENAME}}].",
);
