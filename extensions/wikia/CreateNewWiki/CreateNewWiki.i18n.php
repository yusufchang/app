...
$messages['de'] = array(
	...
	'cnw-desc-default-lang' => 'Die Sprache deines Wikis ist $1',
	...
	'cnw-theme-creative' => 'Jetzt muss es nur noch gut aussehen! Wähle unten ein Theme aus, dann wird dir eine Vorschau angezeigt.',
	'cnw-theme-instruction' => 'Möchtest du dein Theme individuell gestalten? Du kannst später auch dein eigenes Theme entwerfen, indem du auf "Werkzeugkasten" klickst.',
	...
	'autocreatewiki-violate-policy' => 'Im Wiki-Namen ist ein Wort enthalten, dass unsere Richtlinien zur Namensgebung verletzt.',
...
* Wenn du weniger Nachrichten von uns erhalten möchtest, kannst du hier deine E-Mail-Einstellungen ändern: http://de.community.wikia.com/Spezial:Einstellungen',
	...
	'autocreatewiki-welcometalk-wall' => 'Hallo {{subst:SITENAME}}! Wir freuen uns, dass du jetzt auch Teil der Wikia-Gemeinschaft bist!
...
* Sieh dir bei den [[Special:WikiFeatures|Wiki-Funktionen]] an, welche Erweiterungen - wie zum Beispiel Chats oder Herausforderungen - du in deinem Wiki aktivieren kannst.
* Du kannst das Aussehen deines Wikias im [Special:ThemeDesigner|Theme-Designer]] individuell anpassen. Dort kannst du deinen Hintergrund und deine Wortmarke mit Farben und anderen Stilelementen verändern.
* Besuche die [[w:c:community|deutsche Wikia-Community]], um dich über das [[w:c:community:Blog:Wikia_Staff_Blog|Wikia-Blog]] immer up to date zu halten, Fragen im [[w:c:community:Special:Forum|Community-Forum]] zu stellen, an unseren [[w:c:community:Help:Webinars|Webinars]] teilzunehmen oder mit anderen Wikianern zu chatten.
* Außerdem kannst du alles zur Nutzung von Wikia auf unseren [[Hilfe:Übersicht|Hilfeseiten]] lernen. Besonders interessant sind zum Beispiel die Seiten, auf denen du lernst, wie du [[Help:New page|deinem Wikia eine neue Seite hinzufügen]], [[Help:Attracting contributors|neue Beitragende für dein Wiki finden]] und [[Help:User access levels|weitere Wiki-Admins hinzufügen]] kannst.
...
Wir freuen uns, dass $4 jetzt Teil der Wikia-Gemeinschaft ist! Es gibt noch einiges zu tun, deshalb hier nun als Hilfe ein paar Tipps und Links, damit dein Wikia ordentlich in Fahrt kommt!
* Schau dir bei den [[Special:WikiFeatures|Wiki-Funktionen]] an, welche Erweiterungen du in deinem Wiki aktivieren kannst.
* Besuche [[w:c:community|die deutsche Wikia-Community]], um dich im [[w:c:community:Blog:Wikia_Staff_Blog|Wikia-Blog]] immer up to date zu halten, Fragen im [[w:c:community:Special:Forum|Community-Forum]] zu stellen, an unseren [[w:c:community:Help:Webinars|Webinars]] teilzunehmen oder mit anderen Wikianern zu chatten.
* Und vergiss nicht, unsere [[Hilfe:Übersicht|Hilfeseiten]] zu besuchen, um alles rund um die Nutzung von Wikia zu lernen.
...
$messages['es'] = array(
	...
	'cnw-name-wiki-creative' => 'Crea una web, haz crecer una comunidad y embárcate en tu experiencia fan definitiva.',
	...
	'cnw-auth-signup-creative' => 'Necesitarás una cuenta para seguir creando tu wikia.<br />¡Solamente tardarás un minuto para registrarte!',
	...
	'cnw-desc-tip2' => 'PD:',
	'cnw-desc-tip2-creative' => 'Anima a otros a participar en tu comunidad ofreciendo detalles sobre tu wikia.',
...
$messages['fr'] = array(
	...
	'cnw-desc-creative' => 'Une description de qualité donnera de la visibilité à votre wikia.',
	...
	'autocreatewiki-title-template' => 'Le wikia $1',
	'autocreatewiki-tagline' => '',
...
$messages['id'] = array(
	...
	'cnw-desc-headline' => 'Tentang wiki Anda?',
	...
	'cnw-desc-tip1-creative' => 'Menggunakan ruang ini untuk memberitahu orang tentang wiki Anda (tulis dalam satu atau dua kalimat)',
	'cnw-desc-tip2' => 'Tulis',
...
$messages['it'] = array(
	...
	'cnw-auth-signup-creative' => 'Devi avere un account per continuare a costruire la tua wiki. <br />Basta solo un minuto per registrarsi!',
	...
	'cnw-userauth-marketing-body' => 'Devi avere un account per creare una wiki su Wikia. Basta solo un minuto per registrarsi!',
	'cnw-userauth-signup-button' => 'Registrati',
	'cnw-desc-headline' => "Qual è l'argomento della tua wiki?",
	'cnw-desc-creative' => "Permetti agli altri di trovare la tua wiki con un'eccellente descrizione.",
	...
	'cnw-desc-tip1-creative' => "Utilizza questo spazio per descrivere l'importanza e lo scopo della tua wiki.",
	'cnw-desc-tip2' => 'Psst!',
	'cnw-desc-tip2-creative' => 'Incoraggia i visitatori a unirsi alla tua community offrendo dettagli sulla tua wiki.',
	...
	'cnw-error-wiki-limit' => "Ciao! Puoi creare fino a un massimo di {{PLURAL:$1|$1 wiki creation|$1 wiki creations}} al giorno. Attendi 24 ore prima di creare un'altra wiki.",
	...
	'cnw-error-bot' => 'Ti abbiamo identificato come un probabile bot. Se si tratta di un errore, contattaci per spiegare che sei stato erroneamente rilevato come bot e ti aiuteremo a creare la tua wiki: [http://www.wikia.com/Special:Contact/general_Contattaci]',
	...
	'autocreatewiki-info-category-default' => 'Aiuterà i visitatori a trovare la tua wiki.',
	...
	'autocreatewiki-info-terms-agree' => "Con la creazione di una wiki e di un account utente, accetti i {{#NewWindowLink: w:Terms of use | Wikia's Terms of Use}}",
	'autocreatewiki-info-staff-username' => "<b>Solo staff:</b> L'utente specificato verrà indicato come il fondatore.",
	'autocreatewiki-title-template' => '$1 Wikia',
	'autocreatewiki-tagline' => '',
	'autocreatewiki-limit-day' => 'Oggi Wikia ha superato il numero massimo di creazione di wiki ($1).',
	'autocreatewiki-limit-creation' => 'Hai superato il numero massimo di creazione di wiki in 24 ore ($1).',
	...
	'autocreatewiki-similar-wikis' => 'Di seguito trovi le wiki già create su questo argomento. Ti consigliamo di contribuire a una di queste.',
	...
	'autocreatewiki-empty-language' => 'Scegli la lingua per la wiki.',
...
La tua wiki è stata creata. Puoi trovarla qui: <$1>
...
*Fai un salto nella [[w:c:community|Wiki della Community]] per tenerti informato tramite il nostro [[w:it:community:Blog:Wikia_Staff_Blog|Blog ufficiale di Wikia Italia]], per fare delle domande nel [[w:it:community:Special:Forum|Forum della Community]], per partecipare ai nostri [[w:it:community:Help:Webinars|webinar]] o alla [[w:it:community:Special:Chat|chat]] con altri utenti di Wikia.
...
* Puoi anche usare tutti questi strumenti esplorando il tuo Pannello di controllo Admin, che puoi trovare cliccando su \"Pannello Admin\" nella barra degli strumenti in basso .
...
Tutti questi link sono un buon punto di partenza per entrare nel mondo di Wikia e dare inizio al divertimento!
...
$messages['ja'] = array(
	...
	'autocreatewiki-chooseone' => '1つ選択',
	'autocreatewiki-required' => '$1は必須です',
	'autocreatewiki-web-address' => 'ウェブアドレス：',
	'autocreatewiki-category-select' => '1つ選択',
	...
	'autocreatewiki-info-domain' => 'トピックの検索キーワードとなるような言葉が適しています。',
	'autocreatewiki-info-topic' => '「スターウォーズ」や「テレビ番組」など、簡単な説明を追加してください。',
	'autocreatewiki-info-category-default' => '訪問者にあなたのウィキアを見つけてもらいやすくなります。',
	'autocreatewiki-info-category-answers' => '訪問者にあなたのアンサーサイトを見つけてもらいやすくなります。',
	'autocreatewiki-info-language' => 'ここで選択した言語がウィキアの訪問者にデフォルトで表示されます。',
	'autocreatewiki-info-email-address' => 'あなたのメールアドレスがウィキア上で誰かに表示されることはありません。',
	'autocreatewiki-info-realname' => '本名を入力すると、作者名として使用されます。',
	'autocreatewiki-info-birthdate' => 'ウィキアでは、アメリカ合衆国の法規定に則り、サイトの品質維持および安全対策としてすべてのユーザーに対して生年月日の入力を求めています。',
	'autocreatewiki-info-blurry-word' => 'ボットなどによるアカウントの自動作成を防ぐため、表示されている文字を入力してください。',
	'autocreatewiki-info-terms-agree' => "ウィキアおよびユーザーアカウントを作成すると、{{#NewWindowLink: w:Terms of use | Wikia's Terms of Use}}に同意したことになります。",
	...
	'autocreatewiki-limit-creation' => '24時間内に作成可能なウィキアの上限数（$1）を超えました。',
	'autocreatewiki-empty-field' => 'この項目は空白にできません。',
	'autocreatewiki-bad-name' => '名前には$や@などの特殊文字は使えません。また、ローマ字は全てスペースなしの小文字にしてください。',
	'autocreatewiki-invalid-wikiname' => '名前には$や@などの特殊文字は使えません。また、空白にすることもできません。',
	'autocreatewiki-violate-policy' => 'このウィキア名には、ウィキアの名前ポリシーに違反する単語が含まれています。',
	'autocreatewiki-name-taken' => 'このアドレスのウィキアは既に存在します。<a href="http://$1.wikia.com">http://$1.wikia.com</a> で編集するか、別のアドレスを指定してください。',
	'autocreatewiki-name-too-short' => 'アドレスが短すぎます。3文字以上のアドレスを指定してください。',
	'autocreatewiki-name-too-long' => 'アドレスが長すぎます。50文字以下のアドレスを指定してください。',
	'autocreatewiki-similar-wikis' => 'このトピックのウィキアには以下のものが既に存在します。これらのいずれかを編集してください。',
	'autocreatewiki-invalid-username' => 'このユーザー名は無効です。',
	'autocreatewiki-busy-username' => 'このユーザー名は既に使われています。',
	'autocreatewiki-blocked-username' => 'アカウントを作成できません。',
	'autocreatewiki-user-notloggedin' => 'アカウントは作成しましたがログインしていません。',
	'autocreatewiki-empty-language' => 'ウィキアの言語を選択してください。',
	...
	'autocreatewiki-set-username' => 'まずユーザー名を指定してください。',
...
ドロップダウン・リストから適切なものを選択してください。',
	...
	'autocreatewiki-invalid-birthday' => '生年月日が無効です。',
	'autocreatewiki-log-title' => 'ウィキアを作成しています...',
	'autocreatewiki-step0' => 'プロセスを初期化しています...',
	'autocreatewiki-stepdefault' => 'プロセスを実行しています。お待ちください...',
	...
	'autocreatewiki-welcomesubject' => '「$1」作成のお知らせ',
	'autocreatewiki-welcomebody' => '$2さん

この度はウィキアを作成していただきありがとうございます。さっそく、<$1> でチェックしてみてください。

トークページ（<$5>）にリンクをいくつか追加いたしました。ウィキアの便利なツールなど、ご利用のヒントとしてご参照ください。その他ご不明な点がありましたら、このメールにご返信いただくか、ヘルプページ（<http://ja.community.wikia.com/wiki/ヘルプ:コンテンツ>）をご覧ください。

また、ファウンダー＆アドミンのブログ（<http://community.wikia.com/wiki/Blog%3AWikia_Founders_%26_Admins>）やウィキアのスタッフブログ（<http://community.wikia.com/wiki/Blog:Wikia_Staff_Blog>）もご一読ください。ご利用のヒント、新機能に関する情報、ウィキアでの最新情報などをご紹介しています。
...
___________________________________________
* ウィキアから送信される通知の数の変更をご希望の場合は、こちらで登録を解除するか、メール設定をご変更ください：http://community.wikia.com/Special:Preferences',
	'autocreatewiki-welcometalk-wall-title' => 'ようこそ！',
	'autocreatewiki-welcometalk-wall' => 'こんにちは。この度は、ウィキア・コミュニティに{{subst:SITENAME}}を追加していただき、ありがとうございます。

下記に、ウィキアの運営に関するヒントやリンクをご紹介いたします。ご参照ください。
*[[Special:WikiFeatures|ウィキ・フィーチャーズ]]でご自身のウィキアで有効にできる機能（チャット、アチーブメントなど）を確認できます
*[[Special:ThemeDesigner|テーマデザイナー]]では、背景とロゴに色やスタイルを追加してウィキアのデザインをカスタマイズできます
*[[w:ja:メインページ|コミュニティ・セントラル]]では、[[w:c:community:Blog:Wikia_Staff_Blog|スタッフブログ]]で最新情報を入手したり、[[w:ja:特別:Forum|コミュニティ・フォーラム]]で質問したりできるほか、[[w:c:community:Help:Webinars|ウェビナーシリーズ]]に参加したり、他のウィキアンとリアルタイムで[[w:ja:特別:Chat|チャット]]したりすることもできます
*[[w:ja:ヘルプ:コンテンツ|ヘルプページ]]では、[[w:ja:ヘルプ:New_page|ウィキアに新規ページを追加する方法]]、[[w:ja:ヘルプ:Attracting_contributors|コミュニティを作り上げる方法]]、[[w:ja:ヘルプ:User_access_levels|管理者を追加する方法]]など、さまざまなウィキアの使い方についての記事を読むことができます
*管理者ダッシュボード（下部のツールバーで[アドミン]をクリック）でも、上記のすべてのツールをお使いいただけます

上記のリンクを活用して、ウィキアの運営をお楽しみください。',
	'autocreatewiki-welcometalk' => '==ようこそ！==
こんにちは。

この度は、ウィキア・コミュニティに「$4」を追加していただきありがとうございます。下記に、ウィキアの運営に関するヒントやリンクをご紹介いたします。ご参照ください。

*[[Special:WikiFeatures|ウィキ・フィーチャーズ]]でご自身のウィキアで有効にできる機能（チャット、アチーブメントなど）を確認できます
*[[w:ja:メインページ|コミュニティ・セントラル]]では、[[w:c:community:Blog:Wikia_Staff_Blog|スタッフブログ]]で最新情報を入手したり、[[w:ja:特別:Forum|コミュニティ・フォーラム]]で質問したりできるほか、[[w:c:community:Help:Webinars|ウェビナーシリーズ]]に参加したり、他のウィキアンとリアルタイムでチャットしたりすることもできます
*最後に、[[w:ja:ヘルプ:コンテンツ|ヘルプページ]]では、さまざまなウィキアの使い方についての記事を読むことができます
...
$messages['lb'] = array(
	...
	'cnw-desc-creative' => 'Är Beschreiwung hëlleft Leit fir Är Wikia ze fannen',
	'cnw-desc-tip1' => 'Tipp',
	'cnw-desc-tip1-creative' => 'Benotzt dës Plaz fir de Leit an engem oder zwee Säz eppes iwwer Är Wikia ze soen',
	'cnw-desc-tip2' => 'Psst',
	'cnw-desc-select-vertical' => 'Eng Hub-Kategorie eraussichen',
	'cnw-desc-select-categories' => 'Zusätzlech Kategorien eraussichen',
	'cnw-desc-select-one' => 'Een/Eng eraussichen',
	'cnw-desc-all-ages' => 'Ass dës Wikia fir Kanner geduecht?',
	'cnw-desc-default-lang' => 'Är Wiki ass op $1',
...
$messages['ms'] = array(
	...
	'cnw-desc-creative' => 'Huraian anda akan membolehkan orang ramai untuk menemui wikia anda',
	...
	'cnw-desc-select-vertical' => 'Pilih Kategori Utama',
...
$messages['pl'] = array(
	...
	'autocreatewiki-info-domain' => 'Najlepiej użyć słowa, które może być słowem kluczowem szukanego tematu.',
...
* Chcesz otrzymywać mniej wiadomości? Możesz zrezygnować z otrzymywania powiadomień lub zmienić ustawienia powiadomień tutaj: http://community.wikia.com/Special:Preferences',
	...
	'autocreatewiki-welcometalk-wall' => 'Cieszymy się, że strona {{subst:SITENAME}} dołączyła do społeczności portalu Wikia. 

Pozostało wiele do zrobienia. Oto kilka wskazówek i linków na dobry początek:

*Sprawdź [[Special:WikiFeatures|Wiki Features]], żeby zobaczyć, które funkcje możesz włączyć na swojej wiki, w tym Chat, Osiągnięcia i wiele innych.
*Dostosuj wygląd swojej wiki odwiedzając [[Special:ThemeDesigner|Kreatora Motywów]], gdzie możesz dodać kolor i style do tła i logo.
...
*Na koniec odwiedź [[Help:Contents|strony pomocy]], aby poznać tajniki korzystania z portalu Wikia, w tym [[Help:New page|jak dodać nową stronę do twojej wiki]], [[Help:|jak przyciągnąć współtwórców]], oraz [[Help:User access levels|jak dodać administratorów]].
...
*Zajrzyj na [[w:c:community|Centrum Społeczności]], aby być na bieżąco dzięki
[[w:c:community:Blog:Wikia_Staff_Blog|blogowi staff]], aby zadawać pytania wejdź na [[w:c:community:Special:Forum|forum społeczności]], bierz udział w naszych [[w:c:community:Help:Webinars|webinariach]], oraz w [[w:c:community:Special:Chat|chatach na żywo]] z innymi Wikianami.
*Na koniec odwiedź [[Help:Contents|strony pomocy]], aby poznać tajniki korzystania z portalu Wikia
...
',
	...
	'autocreatewiki-violate-policy' => 'Esse nome de wikia contém uma palavra que viola as nossas políticas de nomeação.',
...
*Pare na [[w:c:community|Central da Comunidade]] para ficar informado através do nosso [[w:c:community:Blog:Wikia_Staff_Blog|blog da staff]], tenha suas dúvidas respondidas no nosso [[w:c:community:Special:Forum|fórum da comunidade]], participe de nossos [[w:c:community:Help:Webinars|webinares]], ou converse ao vivo com outros Wikianos.
*Por último, visite nossas [[Help:Contents|páginas de ajuda]] para aprender mais sobre as manhas de como usar a Wikia, incluindo [[Help:New page|como adicionar uma nova página a sua wikia]], [[Help:Attracting contributors|como atrair contribuidores]] e [[Help:User access levels| como adicionar outros administradores]].
...
*Confira os [[Special:WikiFeatures|Recursos da Wiki]] para ver quais recursos você pode ativar em sua wikia, incluindo Chat, Medalhas e muito mais.
*Pare na [[w:c:community|Central da Comunidade]] para ficar informado através do nosso [[w:c:community:Blog:Wikia_Staff_Blog|blog da staff]], tenha suas dúvidas respondidas no nosso [[w:c:community:Special:Forum|fórum da comunidade]], participe de nossas [[w:c:community:Help:Webinars|séries webinar]] ou converse ao vivo com outros Wikianos.
...
$messages['ru'] = array(
	...
	'cnw-welcome-help' => 'Продолжайте в том же духе! Посетите <a href="http://community.wikia.com">Вики Сообщества</a>, чтобы найти ответы на вопросы, полезные советы и многое другое.',
	...
	'autocreatewiki-violate-policy' => 'Это название вики содержит слово, нарушающее наши правила именования.',
	...
	'autocreatewiki-busy-username' => 'Это имя участника уже используется.',
...
$messages['sco'] = array(
	...
	'cnw-desc-tip-all-ages' => 'Is this wiki aneat ae tapíc that bairns ar interested in? In order tae heelp us complie wi US law we keep track o wikis aneat tapícs that directlie appeal tae bairns 12 year auld n unner.',
	...
	'cnw-theme-instruction' => 'Forby, ye can design yer ain theme later bi gaun tae "Ma Tuils".',
	'cnw-welcome-headline' => 'Weel Dun! $1 haes been creautit',
	'cnw-welcome-instruction1' => 'Clap the button ablo tae stairt eikin pages tae yer wiki.',
...
$messages['sv'] = array(
	...
	'cnw-desc-creative' => 'Din beskrivning kommer hjälpa användare att hitta din wikia',
	'cnw-desc-placeholder' => 'Det här kommer att visas på huvudsidan i din wiki.',
	'cnw-desc-tip1' => 'Tips',
	'cnw-desc-tip1-creative' => 'Använd detta utrymme för att berätta för folk vad din wikia handlar om med en mening eller två',
	'cnw-desc-tip2' => 'Psst',
