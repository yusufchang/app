...
$messages['en'] = array(
	...
	'dpl_log_1' => "Error: Wrong '$0' parameter: '$1'! Help:  <code>$0= <i>empty string</i> (Main)$3</code>.",
	'dpl_log_2' => "Error: Wrong '$0' parameter: '$1'! Help:  <code>$0= <i>full pagename</i></code>.",
	'dpl_log_3' => 'Error: Too many categories! Maximum: $0. Help: increase <code>ExtDynamicPageList::$maxCategoryCount</code> to specify more categories or set <code>ExtDynamicPageList::$allowUnlimitedCategories=true</code> for no limitation. (Set the variable in <code>LocalSettings.php</code>, after including <code>DynamicPageList.php</code>.)',
	'dpl_log_4' => 'Error: Too few categories! Minimum: $0. Help: decrease <code>ExtDynamicPageList::$minCategoryCount</code> to specify fewer categories. (Set the variable preferably in <code>LocalSettings.php</code>, after including <code>DynamicPageList.php</code>.)',
	...
	'dpl_log_6' => "Error: You need to include at least one category if you want to use 'addfirstcategorydate=true' or 'ordermethod=categoryadd'!",
	...
	'dpl_log_14' => "Warning: Wrong '$0' parameter: '$1'! Using default: '$2'. Help: <code>$0= $3</code>.",
	'dpl_log_15' => "Warning: Wrong '$0' parameter: '$1'! Using default: '$2' (no limit). Help: <code>$0= <i>empty string</i> (no limit) | n</code>, with <code>n</code> a positive integer.",
	...
	'dpl_log_19' => "Warning: 'debug=$0' is not in first position in the DPL element. The new debug settings are not applied before all previous parameters have been parsed and checked.",
...
$messages['de'] = array(
	...
	'dpl_log_1' => "Fehler: bei '$0' Parameter: '$1'! Hilfe:  <code>$0= <i>(leer)</i> (Hauptnamensraum)$3</code>.",
	'dpl_log_2' => "Fehler: bei '$0' Parameter: '$1'! Hilfe:  <code>$0= <i>vollständiger Seitenname</i></code>.",
	'dpl_log_3' => 'Fehler: Zu viele Kategorien angegeben! Maximum: $0.',
	'dpl_log_4' => 'Fehler: Zu wenige Kategorien angegeben! Minimum: $0.',
	...
	'dpl_log_15' => "Warnung: Parameter '$0': Der Wert '$1' ist unzulässig. Es wird der Defaultwert benutzt: '$2'. Help: <code>$0= <i>(leer)</i> (unbegrenzt) | n</code>, wobei <code>n</code> eine positive Ganzzahl sein muss.",
	'dpl_log_16' => 'Warnung: Kein passender Eintrag gefunden!',
	'dpl_log_17' => "Warnung: Add* Parameter ('adduser', 'addeditdate', etc.)' und 'includepage' haben keinen Effekt in Verbindung mit 'mode=category'. Es kann nur der Artikel und der Namensraum angezeigt werden.",
	'dpl_log_18' => "Warnung: 'headingmode=$0' hat keinen Effekt, wenn 'ordermethod' sich auf eine einzelne Komponente bezieht. Es wird '$1' verwendet. Hilfe: Sie können nicht not-$1 'headingmode' Werte in verbindung mit 'ordermethod' für mehrfache Komponenten verwenden. Die erste Konponente wird als Überschrift verwendet. Z.B. 'ordermethod=category,<i>comp</i>' (<i>comp</i> ist eine andere Komponente) für Kategorie-Überschriften.",
...
$messages['fr'] = array(
	...
	'dpl_log_3' => 'ERREUR : Trop de catégories ! Maximum : $0. Aide : accroître <code>ExtDynamicPageList::$maxCategoryCount</code> pour autoriser plus de catégories ou régler <code>ExtDynamicPageList::$allowUnlimitedCategories=true</code> pour aucune limite. (À régler dans <code>LocalSettings.php</code>, après avoir inclus <code>DynamicPageList.php</code>.)',
	'dpl_log_4' => 'ERREUR : Pas assez de catégories ! Minimum : $0. Aide : décroître <code>ExtDynamicPageList::$minCategoryCount</code> pour autoriser moins de catégories. (À régler dans <code>LocalSettings.php</code> de préférence, après avoir inclus <code>DynamicPageList.php</code>.)',
	'dpl_log_5' => "ERROR: No selection criteria found! You must use at least one of the following parameters: category, namespace, titlematch, linksto, uses, createdby, modifiedby, lastmodifiedby or their 'not' variants",
...
$messages['he'] = array(
	...
	'dpl_log_4' => 'שגיאה: קטגוריות מעטות מדי! מינימום: $0. עזרה: הורידו את <code>ExtDynamicPageList::$minCategoryCount</code> כדי לציין פחות קטגוריות. (הגידרו את המשתנה בקובץ <code>LocalSettings.php</code>, לאחר הכללת <code>DynamicPageList.php</code>.)',
	'dpl_log_5' => "ERROR: No selection criteria found! You must use at least one of the following parameters: category, namespace, titlematch, linksto, uses, createdby, modifiedby, lastmodifiedby or their 'not' variants",
...
$messages['id'] = array(
	...
	'dpl_log_4' => 'KESALAHAN: Kategori terlalu sedikit! Minimum: $0. Bantuan: kurangi <code>ExtDynamicPageList::$minCategoryCount</code> untuk mengurangi kategori. (Atur variabel tersebut di <code>LocalSettings.php</code>, setelah mencantumkan <code>DynamicPageList.php</code>.)',
	'dpl_log_5' => "ERROR: No selection criteria found! You must use at least one of the following parameters: category, namespace, titlematch, linksto, uses, createdby, modifiedby, lastmodifiedby or their 'not' variants",
...
$messages['it'] = array(
	...
	'dpl_log_4' => 'ERRORE: Categorie insufficienti (minimo $0). Suggerimento: diminuire il valore di <code>ExtDynamicPageList::$minCategoryCount</code> per indicare un numero minore di categorie. (Impostare la variabile nel file <code>LocalSettings.php</code>, dopo l\'inclusione di <code>DynamicPageList.php</code>.)',
	'dpl_log_5' => "ERROR: No selection criteria found! You must use at least one of the following parameters: category, namespace, titlematch, linksto, uses, createdby, modifiedby, lastmodifiedby or their 'not' variants",
...
$messages['nl'] = array(
	...
	'dpl_log_2' => 'FOUT: Te veel categoriën! Maximum: $0. Hulp: verhoog <code>ExtDynamicPageList::$maxCategoryCount</code> om meer categorieën op te kunnen geven of stel geen limiet in met <code>ExtDynamicPageList::$allowUnlimitedCategories=true</code>. (Neem deze variabele op in <code>LocalSettings.php</code>, na het toevoegen van <code>DynamicPageList.php</code>.)',
	'dpl_log_3' => 'FOUT: Te weinig categorieën! Minimum: $0. Hulp: verlaag <code>ExtDynamicPageList::$minCategoryCount</code> om minder categorieën aan te hoeven geven. (Stel de variabele bij voorkeur in via <code>LocalSettings.php</code>, na het toevoegen van <code>DynamicPageList.php</code>.)',
...
$messages['sk'] = array(
	...
	'dpl_log_4' => 'CHYBA: Príli málo kategórií! Minimum: $0. Pomocník: zníte <code>ExtDynamicPageList::$minCategoryCount</code>, aby ste mohli pecifikovat menej kategórií. (Premennú nastavte najlepie v <code>LocalSettings.php</code> potom, ako v nom bol includovaný <code>DynamicPageList.php</code>.)',
	'dpl_log_5' => "ERROR: No selection criteria found! You must use at least one of the following parameters: category, namespace, titlematch, linksto, uses, createdby, modifiedby, lastmodifiedby or their 'not' variants",
...
$messages['sr-el'] = array(
	...
	'dpl_log_3' => 'GREŠKA: Previše kategorija! Maksimum je: $0. Pomoć: povećajte <code>ExtDynamicPageList::$maxCategoryCount</code> kako biste postavili više kategorija ili promenite <code>ExtDynamicPageList::$allowUnlimitedCategories=true</code> za bez granica. (Podesite varijablu u <code>LocalSettings.php</code>, nakon uključivanja <code>DynamicPageList.php</code>.)',
	'dpl_log_4' => 'GREŠKA: Premalo kategorija! Minimum je: $0. Pomoć: povećajte <code>ExtDynamicPageList::$minCategoryCount</code> kako biste postavili manje kategorija. (Podesite varijablu u <code>LocalSettings.php</code>, nakon uključivanja <code>DynamicPageList.php</code>.)',
	'dpl_log_5' => "ERROR: No selection criteria found! You must use at least one of the following parameters: category, namespace, titlematch, linksto, uses, createdby, modifiedby, lastmodifiedby or their 'not' variants",
