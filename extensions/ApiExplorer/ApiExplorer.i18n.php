<?php
/**
 * Internationalisation file for extension ApiExplorer.
 *
...
$messages['be-tarask'] = array(
	...
	'apiexplorer-intro' => 'На гэтай старонцы паказваецца дакумэнтацыя для API цяперашняй вікі. Калі ласка, націсьніце на функцыю ніжэй, каб пабачыць больш зьвестак пра тое, якія парамэтры могуць быць выкарыстаныя пры кожным выкліку. Глядзіце таксама [http://www.mediawiki.org/wiki/API:Main_page агульную дакумэнтацыю MediaWiki API].',
