...
Für weitere Optionen nutze bitte die folgenden Aktionen: $1.',
	...
	'sf_createclass_leavefieldblank' => 'Sofern der Feldname dem Attributnamen entspricht, kann das entsprechende Eingabefeld leer gelassen werden.',
...
$messages['es'] = array(
	...
	'sf_createform_template' => 'Etiqueta de la plantilla (opcional):',
	'sf_createform_templatelabelinput' => 'Etiqueta de la plantilla (opcional):',
	...
	'sf_formedit_altforms' => 'Por favor seleccionar de uno de los siguientes formularios para agregar esta página:',
	'sf_formedit_altformsonly' => 'Por favor seleccionar de uno de los siguientes formularios para agregar esta página:',
...
quelque chose comme « Special:RunQuery/<nom du formulaire> ».',
	...
	'sf_bad_email_error' => 'doit avoir un format d’adresse e-mail valide',
	...
	'uploadwindow' => "Fenêtre d'importation",
...
"Special:FormEdit?form=<フォーム名>&target=<対象ページ>" あるいは "Special:FormEdit/<フォーム名>/<対象ページ>" というような形式になります。',
	...
	'sf_autoedit_readonly' => 'データベースは現在、変更を加えることができないようロックされています。　理由： $1',
);
...
$messages['lv'] = array(
	...
	'sf_bad_integer_error' => 'jābūt derīgam veselam skaitlim',
...
W przeciwnym wypadku będziesz mógł edytować z użyciem formularza nową stronę.',
	...
	'sf_formedit_createtitle' => 'Tworzenie $1',
...
Jeśli strona o tej nazwie już istnieje, otwarty zostanie formularz edycji tej strony.',
	...
	'sf_createclass_nameinput' => 'Nazwa formularza',
	...
	'sf_autoedit_success' => 'Pomyślnie zmodyfikowano [[$1]] używając formularza $2.',
	'sf_autoedit_notargetspecified' => 'Nie określono strony docelowej.',
	'sf_autoedit_noformfound' => 'Nie określono formularza.',
	'sf_autoedit_toomanyformsfound' => 'Więcej niż jeden formularz dostępny na stronie.',
);
...
$messages['sv'] = array(
	...
	'sf_createproperty_proptype' => 'Typ:',
	'templates' => "'''Mallar som används på den aktuella versionen av denna sida:'''",
...
$messages['zh-hant'] = array(
	...
	'sf_createform_allowmultiple' => '在創建的頁面中允許多個（或零個）此模板的實例',
	'sf_createform_field' => '事件:',
	...
	'sf_createclass_leavefieldblank' => '如果字段名和屬性名相同，您可以留空。',
